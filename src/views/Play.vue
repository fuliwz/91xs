...
<style scoped>
.play-page{padding:18px 0 42px;background:#fff}.page-shell{width:1100px;max-width:100%;margin:0 auto}.play-layout{display:grid;grid-template-columns:minmax(0,1fr) 320px;gap:18px;align-items:start}.player-column{min-width:0}.player-card,.video-info-card,.side-card{border:1px solid #e5e5e5;background:#fff}.player-card{overflow:hidden}.player-topbar{height:38px;display:flex;align-items:center;justify-content:space-between;padding:0 12px;background:#078acb;color:#fff;font-size:14px}.player-status{display:flex;gap:7px;align-items:center}.player-status span{width:7px;height:7px;border-radius:50%;background:#fff}.player-format{font-size:12px;opacity:.9}.player-wrap{position:relative;background:#050505}.player{display:block;width:100%;height:auto;min-height:180px;aspect-ratio:16/9;background:#050505}.player-loading{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:12px;color:#aaa;background:rgba(0,0,0,.45);pointer-events:none;font-size:14px}.play-icon{font-size:38px;color:#078acb}.source-bar{display:flex;align-items:center;gap:8px;min-height:42px;padding:6px 10px;background:#f5f5f5;color:#666;overflow-x:auto;white-space:nowrap;font-size:13px}.source-bar button{border:1px solid #ccc;background:#fff;color:#666;padding:6px 11px;cursor:pointer;font-size:13px}.source-bar button.active{border-color:#078acb;background:#078acb;color:#fff}.video-info-card{margin-top:10px;padding:16px}.info-header{display:flex;justify-content:space-between;gap:15px}.eyebrow{font-size:11px;color:#078acb;font-weight:700;letter-spacing:.12em}.eyebrow span{display:inline-block;width:6px;height:6px;border-radius:50%;background:#078acb;margin-right:6px}.video-info-card h1{margin:5px 0 10px;color:#333;font-size:23px;line-height:1.45}.share-btn{height:34px;border:1px solid #ccc;background:#fafafa;color:#666;padding:0 14px;cursor:pointer;font-size:14px}.video-meta{display:flex;flex-wrap:wrap;gap:7px}.video-meta span{padding:5px 9px;background:#f2f2f2;color:#777;font-size:12px}.description{margin-top:12px;padding-top:11px;border-top:1px solid #eee;color:#777;font-size:13px;line-height:1.8}.description b{display:block;color:#555;margin-bottom:5px;font-size:14px}.side-card{padding:14px}.side-heading{display:flex;justify-content:space-between;align-items:center;margin-bottom:12px}.side-heading span{font-size:11px;color:#078acb;font-weight:700;letter-spacing:.1em}.side-heading h2{margin:3px 0 0;color:#444;font-size:18px}.side-heading em{font-style:normal;color:#078acb;font-size:13px}.side-list{display:flex;flex-direction:column;gap:8px}.side-item{display:flex;gap:10px;padding:6px;text-decoration:none}.side-item:hover{background:#f5f9fc}.side-thumb{flex:0 0 105px;height:62px;overflow:hidden;background:#eee}.side-thumb img{width:100%;height:100%;object-fit:cover}.side-item strong{display:-webkit-box;overflow:hidden;color:#555;font-size:13px;line-height:1.45;-webkit-line-clamp:2;-webkit-box-orient:vertical}.side-item small{display:block;margin-top:5px;color:#999;font-size:11px}.side-empty,.recommend-empty,.empty{padding:38px;text-align:center;color:#999;font-size:14px}.recommend-section{margin-top:16px;border:1px solid #e5e5e5;background:#fff}.section-bar{height:50px;display:flex;align-items:center;justify-content:space-between;padding:0 14px;background:#078acb;color:#fff}.section-bar h2{margin:3px 0 0;font-size:16px}.section-bar small{font-size:10px;color:#dff5ff}.section-bar span{font-size:12px}.video-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:6px;padding:8px}@media(max-width:800px){.play-layout{display:block}.side-panel{margin-top:12px}.page-shell{width:100%}.video-info-card{margin-top:8px}.video-info-card h1{font-size:20px}.video-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
</style>